...
namespace SuperMarioBros.Loading
{
    public class SpritesLoading
    {
        private readonly List<SpritesNode> spritesCollection = new List<SpritesNode>
        {
             ...
             new SpritesNode("BrickBlock","BrickBlock",32,32),
             new SpritesNode("ItemBrickBlock","BrickBlock",32,32),
             //special item
             new SpritesNode("BrickDebris","BrickDebris"),
             new SpritesNode("Coin","Coin",14,26,5),
             new SpritesNode("ConcreteBlock","ConcreteBlock",32,32),
             new SpritesNode("UsedBlock","UsedBlock",32,32),
             ...
             new SpritesNode("HiddenBlock","HiddenBlock",28,28),
             ...
             new SpritesNode("QuestionBlock","QuestionBlock",32,32,5), 
             new SpritesNode("RedMushroom","RedMushroom",28,28), 
             new SpritesNode("RockBlock","RockBlock",32,32), 
             ...
             new SpritesNode("FireExplosion","FireExplosion",3), 
        };
