...
namespace SuperMarioBros.Collisions
{
    public static class MarioEnemyCollisionHandler 
    {
        private static readonly Dictionary<(Type,Type,Direction),(Type,Type)> collisionDictionary = new Dictionary<(Type,Type, Direction), (Type, Type)>
        {
            ...
            { (typeof(Mario),typeof(StompedKoopa), Direction.top),    (typeof(BlockLeftAndRightCommand),typeof(Nullable)) },
            { (typeof(Mario),typeof(StompedKoopa), Direction.left),    (typeof(BlockLeftAndRightCommand),typeof(Nullable)) },
            { (typeof(Mario),typeof(StompedKoopa), Direction.right),    (typeof(BlockLeftAndRightCommand),typeof(Nullable)) },
            { (typeof(Mario),typeof(StompedKoopa), Direction.bottom),    (typeof(BlockLeftAndRightCommand),typeof(Nullable)) },
