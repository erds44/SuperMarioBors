    ...
    public static class SpriteFactory
    {
        ...
        public static void Initialize(ContentManager inputContent)
        {
            ...
            spriteInfo = new Dictionary<string, ISprite>
            {
                ...
                { "LeftMovingKoopa", new UniversalSprite(content.Load<Texture2D>("KoopaMovingLeft"), 5) },
                { "RightMovingKoopa", new UniversalSprite(content.Load<Texture2D>("KoopaMovingRight"), 5) },
                { "StompedKoopa", new UniversalSprite(content.Load<Texture2D>("KoopaStomped"), 1) },
                { "StompedMovingKoopa", new UniversalSprite(content.Load<Texture2D>("KoopaStomped"), 1) },
