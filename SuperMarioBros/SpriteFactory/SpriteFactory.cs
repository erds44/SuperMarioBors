...
namespace SuperMarioBros.SpriteFactories
{
    public static class SpriteFactory
    {
        ...
        public static void Initialize(ContentManager inputContent)
        {
            ...
            //    { "ItemBrickBlock", new UniversalSprite(content.Load<Texture2D>("BrickBlock"), 1) },
            ...
            //    { "GoombaLeftMovingState", new UniversalSprite(content.Load<Texture2D>("Goomba"), 2) },
            //    { "GoombaRightMovingState", new UniversalSprite(content.Load<Texture2D>("Goomba"), 2) },
            //    { "GoombaStompedState", new UniversalSprite(content.Load<Texture2D>("StompedGoomba"), 1) },
            //    { "FlippedGoombaIdleState", new UniversalSprite(content.Load<Texture2D>("Goomba"), 1) },
            ...
            //    { "KoopaNormalStateKoopaLeftMovingState", new UniversalSprite(content.Load<Texture2D>("KoopaMovingLeft"), 5) },
            //    { "KoopaNormalStateKoopaRightMovingState", new UniversalSprite(content.Load<Texture2D>("KoopaMovingRight"), 5) },
            //    { "KoopaShelledStateKoopaIdleState", new UniversalSprite(content.Load<Texture2D>("KoopaStomped"), 1) },
            //    { "KoopaShelledStateKoopaLeftMovingState", new UniversalSprite(content.Load<Texture2D>("KoopaStomped"), 1) },
            //    { "KoopaShelledStateKoopaRightMovingState", new UniversalSprite(content.Load<Texture2D>("KoopaStomped"), 1) },
            ...
            //    { "FireExplosion", new UniversalSprite(content.Load<Texture2D>("FireExplosion"), 3) }
            //};
        ...
        //public static ISprite CreateSpriteV1(string type)
        //{ 
